 ...
 */
SITKIO_HIDDEN void
PrintRegisteredImageIOs(std::ostream & out);

/* Internal method which creates a string list of the names of the
 * ImageIOs registered.
 */
SITKIO_HIDDEN std::vector<std::string>
              GetRegisteredImageIOs();


SITKIO_HIDDEN itk::SmartPointer<ImageIOBase>
              CreateImageIOByName(const std::string & ioname);
